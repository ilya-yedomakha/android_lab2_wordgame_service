...
//    public static SettingsFragment newInstance(int difficulty, int timer_minutes) {
//        Bundle args = new Bundle();
//
//        args.putInt(DIFFICULTY, difficulty);
//        args.putInt(TIMER_MINUTES, timer_minutes);
...
//    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.saveButton).setOnClickListener(v -> {
            getLoadService().saveSettings(difficulty,timer_minutes);
